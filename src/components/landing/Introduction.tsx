...
export const Introduction = () => {
  return (
    <div className="relative h-fit w-full">
      ...
      <div className="absolute left-5 top-1/2 flex -translate-y-1/2 flex-col gap-2 text-white md:left-[15%] md:gap-6">
        <span className="text-xl font-bold uppercase md:text-2xl lg:text-4xl">
          What happend!
        </span>
        <span className="text-wrap text-xs md:w-[60%] md:text-xl lg:w-[40%] lg:text-2xl">
